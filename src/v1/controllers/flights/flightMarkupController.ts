...
<style>
  ...
  .view--half_vertical .layout, .view--half_vertical .columns, .view--half_vertical .column, .view--half_vertical .markdown { display: flex; flex-direction: column; flex: 1; padding: 0; }
