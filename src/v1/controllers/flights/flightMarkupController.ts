...
<style>
  .view { padding: 0 8px;  }
  .flight-card { margin: ${variant === 'half_vertical' ? '12px 0 0' : '0'}; padding: ${variant === 'full' ? '12px 24px' : variant === 'half_vertical' ? '10px 0' : variant === 'half_horizontal' ? '8px 0' : '6px 8px'}; font-family: 'IBM Plex Sans', 'SF Pro Text', 'Segoe UI', sans-serif; }
  ...
  .view--half_vertical { display: flex; flex-direction: column; flex: 1; align-items: stretch; padding: 0 8px !important; margin: 0 !important; width: 100% !important; max-width: 100% !important; height: 100%; }
